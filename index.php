...
<div id="main">
	...
	<p>This application is intended to provide an offline environment for people interested in hacking/pentesting to test their skills. A basic challenge has been set for each page just to give you something to aim for.  This is by no means the only possible target and others may be added in the future.
